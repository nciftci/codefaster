...
insert  into `config`(`id`,`description`,`name`,`value`,`comment`,`type`,`pagenr`,`position`,`image`,`help_description`,`url`,`template`) values (40,'LANG_CONF_USER','USER','admin',NULL,1,1,7,'','','admintool/login.php,admintool/mailtoallusers.php,conect.php','include/authenticate.php');
insert  into `config`(`id`,`description`,`name`,`value`,`comment`,`type`,`pagenr`,`position`,`image`,`help_description`,`url`,`template`) values (41,'LANG_CONF_PASSWORD','PASSWORD','setup',NULL,1,1,8,'','','admintool/login.php,admintool/mailtoallusers.php,admintool/password_recovery.php,activation.php,forgetpassword.php,login.php,registration.php,resendactivationemail.php,conect.php','include/authenticate.php,cls_regbusiness.php');
insert  into `config`(`id`,`description`,`name`,`value`,`comment`,`type`,`pagenr`,`position`,`image`,`help_description`,`url`,`template`) values (42,'LANG_CONF_SITE_NAME','CONF_SITE_NAME','Site PresentationPresentation',NULL,1,1,1,'','','','');
