...
**/
	...
	$Obj = new Listing();
	$Obj -> init_mysql( DB_PREFIX . 'product', array( id, name ) );// replace data from listing from other table
...
**/
	...
	else
	{
		...
		if( !empty( $all_url_vars[ 'descriptionshort_delete' ] ) )
		{
...
case 'save_crop'://Get the new coordinates to crop the image.
	...
	case 'descriptionshort':
		$testproduct -> setdescriptionshort( $_SESSION[ 'uploaded_file' ] );
		break;
	case 'fileupload':
