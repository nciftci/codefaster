...
**/
	public function __construct( $id = 0, $lang = 'en' )
	{
		...
		$SQL = ' SELECT `name`,`descriptionshort`,`description`,`categoryid`,`isthisreal`,`termsagree`,`fileupload`,`active`,`cucurigu` FROM `' . DB_PREFIX . 'product` ' . $this -> where_clause;
...
* @author   - Test Developer
* @type     - public
* @desc     - get $this->cucurigu
* @return   - string
* @vers     - 1.0
* @Mod  	-
**/
	public function getCucurigu()
	{
		return $this -> cucurigu;
	}// end getCucurigu()
...
* @author   - Test Developer
* @type     - public
* @desc     - set $this->cucurigu to $cucurigu
* @param    - string $cucurigu
* @return   - void
* @vers     - 1.0
* @Mod  	-
**/
	public function setCucurigu( $cucurigu )
	{
		$this -> cucurigu = $cucurigu;
	}// end setCucurigu()
...
**/
	public function save()
	{
		...
		{
			$SQL = 'INSERT INTO `' . DB_PREFIX . 'product` (`name`,`descriptionshort`,`description`,`categoryid`,`isthisreal`,`termsagree`,`fileupload`,`active`,`cucurigu`)';
			$SQL .= ' VALUES(\'' . $this -> slashes( $this -> name ) . '\',\'' . $this -> slashes( $this -> descriptionshort ) . '\',\'' . $this -> slashes( $this -> description ) . '\',\'' . $this -> slashes( $this -> categoryid ) . '\',\'' . $this -> slashes( $this -> isthisreal ) . '\',\'' . $this -> slashes( $this -> termsagree ) . '\',\'' . $this -> slashes( $this -> fileupload ) . '\',\'' . $this -> slashes( $this -> active ) . '\',\'' . $this -> slashes( $this -> cucurigu ) . '\')';
